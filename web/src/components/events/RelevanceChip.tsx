...
export interface RelevanceChipProps {
 ...
 */
export function RelevanceChip({ reasons = [], score, compact = false, style }: RelevanceChipProps) {
  ...
  return (
    ...
    >
      <svg
        width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--spot)"
      ...
      >
        <b style={{ fontWeight: "var(--fw-semibold)", textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--spot)" }}>
          Matches
        </b>
