 ...
 */
export function DigestItem({ index, event, onOpen, style }: DigestItemProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <h4 style={{ fontFamily: "var(--font-display)", fontSize: "var(--fs-title)", color: "var(--text-strong)", margin: "0 0 4px", lineHeight: "var(--lh-snug)" }}>
          {title}
        </h4>
      ...
      <div style={{ flex: "0 0 auto" }}>{(free || price != null) && <PriceTag price={price} free={free} />}</div>
    </div>
  );
}
