...
const sizes: Record<string, number> = { sm: 36, md: 44, lg: 52 };
...
/**
 * Square/circular icon-only control. Pass an 18–22px icon node as children.
  ...
  return (
    <button
      ...
      style={{
        ...
        transition:
          "background var(--dur-2) var(--ease-out), transform var(--dur-1) var(--ease-out), color var(--dur-2)",
        ...base,
        ...activeStyle,
        ...style,
      }}
